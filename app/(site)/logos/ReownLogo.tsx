...
interface ReownLogoProps extends SVGProps<SVGSVGElement> {
  className?: string;
}

export default function ReownLogo({ className, ...props }: ReownLogoProps) {
  return (
    <div className={className}>
      ...
      >
        <path
          fill="#202020"
          d="M28 14c0-7.732 6.268-14 14-14h20c7.732 0 14 6.268 14 14v20c0 7.732-6.268 14-14 14H42c-7.732 0-14-6.268-14-14V14Z"
        ></path>
        <path fill="#fff" d="m46.816 33 7.018-19h2.06l-7.017 19h-2.06Z"></path>
        <path
          fill="#202020"
          d="M0 13C0 5.82 5.82 0 13 0s13 5.82 13 13v22c0 7.18-5.82 13-13 13S0 42.18 0 35V13Z"
        ></path>
        <path fill="#fff" d="M11.75 29.999v-2.5h2.5v2.5h-2.5Z"></path>
        <path
          fill="#202020"
